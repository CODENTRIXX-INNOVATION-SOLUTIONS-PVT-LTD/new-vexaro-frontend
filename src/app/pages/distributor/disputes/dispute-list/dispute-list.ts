...
export class DisputeList implements OnInit {
  ...
  loadDisputes() {
    this.isLoading = true;
    // TODO: Replace with real API call: GET /distributor/:id/disputes
    this.disputes = [
  ...
  // NOTE: When the TODO above is replaced with a real API subscribe call,
  // ensure the error handler also sets this.isLoading = false.
